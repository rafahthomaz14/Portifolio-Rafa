        ...
        <div className="max-w-[1366px] px-6 mx-auto">
            <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                ...
                <div className="Mre">
                    ...
                    <p className="font-extralight text-gray-200 mt-2 mb-2">
                        Landing Page personalizada.
                    </p>
                    <p className="font-extralight text-gray-500 "> TypeScript | JavaScript | Css</p>
                </div>
                ...
                <div className="Vila">
                    ...
                    <p className="font-extralight text-gray-500 ">Html | Css | JavaScript</p>
                ...
                <div className="Plantech">
                    ...
                    <p className="font-extralight text-gray-500 ">C# | SqLite | JavaScript</p>
                </div>
